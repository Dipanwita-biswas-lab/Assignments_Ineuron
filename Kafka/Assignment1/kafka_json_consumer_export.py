    ...
    while True:
        try:
            ...
            if order is not None:
                ...
                row=[order.OrderNumber, order.OrderDate, order.ItemName, order.Quantity ,order.ProductPrice, order.Totalproducts]
                with open(filename, 'a') as csvfile: 
                    ...
                    print(str(order.OrderNumber)+ ' :Order Transfered')
